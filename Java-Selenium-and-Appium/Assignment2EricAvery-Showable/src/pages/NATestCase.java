...
public class NATestCase extends TestAppPages {
	...
	public NATestCase(AndroidDriver driver) {
		super(driver);
	}
	
	//Gets current data set's NA restaurant address
	public String getNAAddress (int choice) {
		return this.getNAAddressOne(choice);
	}
	...
	public void displayRouteTime (int choice) {
		...
		System.out.println("The time from the current device location to " + this.getNAAddress(choice) + " is " + time + "." + System.lineSeparator());
	}
